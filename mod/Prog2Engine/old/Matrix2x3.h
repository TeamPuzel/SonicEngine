...
struct Matrix2x3 final
{
	...
	// std::vector<Vectof2f> transformedVertices = mat.Transform(vertices);
...
// mat1 == mat2
bool operator==( const prog::Matrix2x3& lhs, const prog::Matrix2x3& rhs );
// Are two matrices exactly unequal?
// mat1 != mat2
bool operator!=( const prog::Matrix2x3& lhs, const prog::Matrix2x3& rhs );
// Multiply matrices
// Matrix2x3 matProduct {mat1 * mat2};
prog::Matrix2x3 operator*( const prog::Matrix2x3& lhs, const prog::Matrix2x3& rhs );
// Send matrix to output stream
// std::cout << mat;
std::ostream& operator<<( std::ostream& os, const prog::Matrix2x3& matrix );
