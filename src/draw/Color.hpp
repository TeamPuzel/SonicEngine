...
namespace draw {
    struct Color final {
        ...
        template <typename Blend> constexpr auto blend_over(Color other, Blend const& blend) const -> Color {
    ...
    namespace blend {
        constexpr auto overwrite(Color top, Color bottom) -> Color {
            return top;
        }
        ...
        constexpr auto binary(Color top, Color bottom) -> Color {
        ...
        constexpr auto alpha(Color top, Color bottom) -> Color {
